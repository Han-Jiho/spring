...
<body>
	<div class="map_wrap">
		...
		<p p style="text-align:center">
			...
			<!-- 지도 확대 축소 막기 -->
			<button onclick="setZoomable(true)">지도 확대 / 축소 ON</button>
			<button onclick="setZoomable(false)">지도 확대 / 축소 OFF</button>

			<!-- 지도 이동 막기 -->
			<button onclick="setDraggable(true)">지도 드래그 이동 ON</button>
			<button onclick="setDraggable(false)">지도 드래그 이동 OFF</button>
		</p>
