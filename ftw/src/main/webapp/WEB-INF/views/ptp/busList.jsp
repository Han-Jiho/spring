...
<div class="container">
	...
	<div>
		<table class="table">
			...
			style="width:300px; display: inline" placeholder="정류장을 검색해 주세요">
			<%
			}else{%>
		...
		<%}
			...
			<tr>
				<%if(col.equals("22")){ %>				
					...
					<td><img src="https://cdn.crowdpic.net/list-thumb/thumb_l_88E38F18040B6E5B49B3C4252AE6667D.png" style="display: inline;width: 30px;height: 30px;"><h6 style="color: green;display: inline">마을</h6><div><%=bus_id %><div></div></td>
					<%
					}
						%>				
