		...
		<div class="row">
			<div class="col-md-6">
				...
				<div align="right" class="listBtn">
					<a href="/today/list.do" class="btn btn-default">다른 지역의 날씨 보러가기</a>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<ul class="list-group">
							<c:forEach items="${accident }" var="vo">
								<li class="list-group-item dataRow trafficLi"><a
									href="/accident/view.do?inc=1&no=${vo.no }" class="viewA">
										${vo.title } - ${vo.writer } </a> <span class="badge">${vo.hit }</span></li>
							</c:forEach>
						</ul>
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div align="right" class="listBtn">
					<a href="/ptp/list.do" class="btn btn-default">더보기</a>
				</div>
			</div>
		</div>
	</div>
