...
<body>
<div class="container">
<h1>여기는 교통 정보를 분석/토론하는 커뮤니티입니다.</h1>
	<div id="경고" style="color:red">경고 : 주제와 무관한 글을 올릴 시, IP 차단, 민형사상 처벌 될 수 있습니다.</div>
	<a href="analysis.do" class="btn btn-default" style="font-size:24px">분석 바로가기<i class="fa fa-car"></i></a>
<!-- 검색을 위한 입력 태그 시작 -->
 <div>
