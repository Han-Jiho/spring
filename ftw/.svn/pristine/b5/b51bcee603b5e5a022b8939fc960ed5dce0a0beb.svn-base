...
<body>
	<!-- 움직이는 텍스트 -->
	<MARQUEE scrollamount="8"> 5분 일찍 가려다 50년 빨리 갑니다.&nbsp&nbsp&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp&nbsp&nbsp교통사고에 순서는 없습니다.&nbsp&nbsp&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp&nbsp&nbsp 더 큰 지도 화면을 원하신다면 <a href="traffic.do"/> 클릭해주세요.	</MARQUEE>
